        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="users.php" class="btn btn-sm btn-primary btn-flat"><i class="fa fa-arrow-left"></i> Customer's Menu</a>


              <a href="#addnew" data-toggle="modal" id="add" data-id="<?php echo $user['id']; ?>" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Add Item</a>

              
              
              

              <a href="#" class="btn btn-sm btn-success btn-flat pull-right"><i class="fa fa-check"></i> SUBMIT ORDER</a>
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $pdo->close();
                  ?>
                  <h1 class="text-center">Total: £ <?php echo $total; ?></h1>
                </tbody>
              </table>
            </div>
          </div>
